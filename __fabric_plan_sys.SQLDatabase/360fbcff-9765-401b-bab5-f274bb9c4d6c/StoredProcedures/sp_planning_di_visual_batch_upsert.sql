        ...
        CREATE   PROCEDURE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [360fbcff-9765-401b-bab5-f274bb9c4d6c].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [360fbcff-9765-401b-bab5-f274bb9c4d6c].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [360fbcff-9765-401b-bab5-f274bb9c4d6c].' + QUOTENAME(@DIVTableName) + ' AS div
