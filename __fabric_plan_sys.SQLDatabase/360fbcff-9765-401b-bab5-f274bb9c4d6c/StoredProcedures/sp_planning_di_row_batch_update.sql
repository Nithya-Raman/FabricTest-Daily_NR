            ...
            CREATE PROCEDURE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [360fbcff-9765-401b-bab5-f274bb9c4d6c].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [360fbcff-9765-401b-bab5-f274bb9c4d6c].data_input_row
                INNER JOIN [360fbcff-9765-401b-bab5-f274bb9c4d6c].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
