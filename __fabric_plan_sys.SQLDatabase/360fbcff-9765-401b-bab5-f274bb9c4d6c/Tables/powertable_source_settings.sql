CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_source_settings]([recordGuid] ASC);
