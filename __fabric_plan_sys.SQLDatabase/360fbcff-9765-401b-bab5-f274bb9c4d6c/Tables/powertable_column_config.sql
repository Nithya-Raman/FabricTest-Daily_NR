CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_column_config]([recordGuid] ASC);
