CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [ix_data_input_column_hydration_cold]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[data_input_column]([sidecarHydrationStatus] ASC) WHERE ([sidecarHydrationStatus] IN ((10), (30), (50)));
