CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [IX_comment_parentRecordGuid]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[comment]([parentRecordGuid] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_comment_recordGuid]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[comment]([recordGuid] ASC);
