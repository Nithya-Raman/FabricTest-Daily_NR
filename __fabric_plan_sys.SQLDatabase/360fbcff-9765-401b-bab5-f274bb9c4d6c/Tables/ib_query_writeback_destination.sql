CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[ib_query_writeback_destination]([recordGuid] ASC);
