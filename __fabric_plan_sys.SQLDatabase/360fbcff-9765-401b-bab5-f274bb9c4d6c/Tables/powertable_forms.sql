CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_forms]([recordGuid] ASC);
