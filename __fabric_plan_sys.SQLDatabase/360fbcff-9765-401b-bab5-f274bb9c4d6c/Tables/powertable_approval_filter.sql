CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_approval_filter]([recordGuid] ASC);
