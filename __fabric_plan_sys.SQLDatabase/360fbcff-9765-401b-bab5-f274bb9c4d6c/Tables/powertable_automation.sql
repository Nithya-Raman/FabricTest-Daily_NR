CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_automation]([recordGuid] ASC);
