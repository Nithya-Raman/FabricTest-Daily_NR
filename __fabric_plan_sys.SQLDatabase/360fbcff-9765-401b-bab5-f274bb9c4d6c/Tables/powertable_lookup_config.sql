CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_lookup_config]([recordGuid] ASC);
