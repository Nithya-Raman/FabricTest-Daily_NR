CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[visual] ([id])
);
