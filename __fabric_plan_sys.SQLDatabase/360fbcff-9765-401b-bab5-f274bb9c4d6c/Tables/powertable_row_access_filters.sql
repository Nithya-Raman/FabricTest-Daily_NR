CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_row_access_filters]([recordGuid] ASC);
