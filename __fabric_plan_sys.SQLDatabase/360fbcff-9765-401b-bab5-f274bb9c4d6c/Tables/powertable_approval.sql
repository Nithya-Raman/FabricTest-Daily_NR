CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_approval]([recordGuid] ASC);
