CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_approval_request] ([id])
);
