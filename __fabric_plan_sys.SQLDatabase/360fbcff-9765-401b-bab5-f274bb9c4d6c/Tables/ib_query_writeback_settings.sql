CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[ib_query_writeback_settings]([recordGuid] ASC);
