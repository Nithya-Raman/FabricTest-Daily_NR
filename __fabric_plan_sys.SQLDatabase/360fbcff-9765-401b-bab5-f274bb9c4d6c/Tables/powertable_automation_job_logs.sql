CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_automation_jobs] ([id])
);
