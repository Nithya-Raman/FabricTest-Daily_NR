CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[ib_query_transformation_steps]([recordGuid] ASC);
