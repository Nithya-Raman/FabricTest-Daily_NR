CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[cube_partition_sync_logs] (
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
