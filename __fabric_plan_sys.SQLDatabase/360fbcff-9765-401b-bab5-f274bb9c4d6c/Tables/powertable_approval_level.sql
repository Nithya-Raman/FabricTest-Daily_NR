CREATE TABLE [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [360fbcff-9765-401b-bab5-f274bb9c4d6c].[powertable_approval_level]([recordGuid] ASC);
