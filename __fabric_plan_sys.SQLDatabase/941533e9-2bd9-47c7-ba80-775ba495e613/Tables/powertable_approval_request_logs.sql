CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_approval_request] ([id])
);
