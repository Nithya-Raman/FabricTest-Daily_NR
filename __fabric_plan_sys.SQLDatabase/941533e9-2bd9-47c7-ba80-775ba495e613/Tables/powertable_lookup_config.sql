CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_lookup_config]([recordGuid] ASC);
