CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[cube_partition_sync_logs] (
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [941533e9-2bd9-47c7-ba80-775ba495e613].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
