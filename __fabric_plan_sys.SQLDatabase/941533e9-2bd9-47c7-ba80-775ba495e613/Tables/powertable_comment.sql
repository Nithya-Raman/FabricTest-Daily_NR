CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_source] ([id])
);
