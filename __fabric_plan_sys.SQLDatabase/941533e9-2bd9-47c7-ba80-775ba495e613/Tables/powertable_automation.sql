CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_automation]([recordGuid] ASC);
