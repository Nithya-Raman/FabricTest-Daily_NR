CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_row_access_filters]([recordGuid] ASC);
