CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_approval]([recordGuid] ASC);
