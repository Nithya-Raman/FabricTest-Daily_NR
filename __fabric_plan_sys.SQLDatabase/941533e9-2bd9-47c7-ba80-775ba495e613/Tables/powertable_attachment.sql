CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_source] ([id])
);
