CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [941533e9-2bd9-47c7-ba80-775ba495e613].[writeback_settings]([recordGuid] ASC);
