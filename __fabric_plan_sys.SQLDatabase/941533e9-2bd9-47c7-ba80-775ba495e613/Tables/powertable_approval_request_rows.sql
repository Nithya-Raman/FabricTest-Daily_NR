CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_approval_request] ([id])
);
