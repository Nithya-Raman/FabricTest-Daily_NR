CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [IX_comment_parentRecordGuid]
    ON [941533e9-2bd9-47c7-ba80-775ba495e613].[comment]([parentRecordGuid] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_comment_recordGuid]
    ON [941533e9-2bd9-47c7-ba80-775ba495e613].[comment]([recordGuid] ASC);
