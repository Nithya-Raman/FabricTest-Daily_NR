CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_source_settings]([recordGuid] ASC);
