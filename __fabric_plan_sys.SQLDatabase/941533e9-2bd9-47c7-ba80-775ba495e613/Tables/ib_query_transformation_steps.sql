CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [941533e9-2bd9-47c7-ba80-775ba495e613].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [941533e9-2bd9-47c7-ba80-775ba495e613].[ib_query_transformation_steps]([recordGuid] ASC);
