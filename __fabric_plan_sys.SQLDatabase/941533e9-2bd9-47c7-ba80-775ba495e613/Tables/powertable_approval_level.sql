CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_approval_level]([recordGuid] ASC);
