CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[visual] ([id])
);
