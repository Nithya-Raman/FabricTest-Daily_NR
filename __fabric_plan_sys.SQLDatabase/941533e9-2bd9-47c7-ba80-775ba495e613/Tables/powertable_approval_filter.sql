CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_approval_filter]([recordGuid] ASC);
