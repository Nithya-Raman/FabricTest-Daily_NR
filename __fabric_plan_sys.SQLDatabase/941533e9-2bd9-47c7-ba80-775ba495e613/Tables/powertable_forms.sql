CREATE TABLE [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [941533e9-2bd9-47c7-ba80-775ba495e613].[powertable_forms]([recordGuid] ASC);
