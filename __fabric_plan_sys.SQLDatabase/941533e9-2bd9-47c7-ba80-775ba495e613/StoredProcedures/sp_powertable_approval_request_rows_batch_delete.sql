              ...
              CREATE PROCEDURE [941533e9-2bd9-47c7-ba80-775ba495e613].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [941533e9-2bd9-47c7-ba80-775ba495e613].powertable_approval_request_rows SET status = 500 FROM [941533e9-2bd9-47c7-ba80-775ba495e613].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
